...
// @desc    Update or crate current user profile
// @access  private
...
router.delete('/experience/:exp_id', auth, async (req, res) => {
    ...
    try {
        ...
        // if (removeIndex !== req.params.exp_id) {

        //     return res.status(400).json('Cannot delete the experience')
        // }
...
router.delete('/education/:edu_id', auth, async (req, res) => {
    ...
    try {
        ...
        // if (removeIndex !== req.params.edu.id) {

        //     return res.status(400).json('Cannot delete the education')
        // }
